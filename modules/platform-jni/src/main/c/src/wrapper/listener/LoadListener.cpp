...
namespace ujr {
    ...
    void LoadListener::OnBeginLoading(
        ...
        native_access::JNIUlLoadListener::ON_BEGIN_LOADING
            .invoke(env, j_listener, static_cast<jlong>(frame_id), static_cast<jboolean>(is_main_frame), j_url);
    }
    ...
    void LoadListener::OnUpdateHistory(ultralight::View *caller) {
        ...
        // Call the java instance
        native_access::JNIUlLoadListener::ON_UPDATE_HISTORY.invoke(env, j_listener);
    }
